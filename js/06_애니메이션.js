$(function () {
  ...
  */
  ...
  $(".tab-btn").click(function () {
    ...
    // 모든 탭 버튼에서 active 클래스를 제거한 후
    // 현재 클릭한 버튼에만 active 추가
    $(".tab-btn").removeClass("active");
    $(this).addClass("active");

    // 2. 모든 .tap-content를 slidUp 하고, 해당 탭만 slideDown
  ...
  $("#startProgress").click(function () {
    $("#progressBar").animate(
      ...
      function () {
        ...
        // width 100% 만들고 나면 텍스트를 100%로 교체
  ...
  $(선택자).hover(mouseEnter함수,mouseLeave함수); 이런 형태도 있을 수 있음
  */
  $(".dropdown").hover(
    function () {
