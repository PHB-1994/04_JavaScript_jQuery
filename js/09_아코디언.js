$(function () {
  $(".faq-item").click(function () {
    /*
    순수 자바스크립트 에서는
    querySelector() 를 사용했을 때는 맨 앞에 존재하는 tage나 id나 class 선택
    querySelectorAll() 를 사용했을 때는 해당하는 모든 tage나 id나 class 를 담아놓은 상태
    jQuery $(선택자) = 기본적으로 querySelectAll() 상태
    ...
    */
    ...
    /*
    jQuery 는 JavaScript 를 사용하던 개발자가  JavaScript를 사용하며 느낀 불편함을 해소하기 위하여
    만든 라이브러리
